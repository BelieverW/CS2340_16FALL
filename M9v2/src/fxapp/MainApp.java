...
public class MainApp extends Application {
    ...
    public void showReportView(User user, boolean isworker) {
        try {
            ...
            Stage dialogstage = new Stage();
            if (isworker) {
                loader.setLocation(MainApp.class.getResource("../view/WorkerReportView.fxml"));
                ...
                loader.setLocation(MainApp.class.getResource("../view/ReportView.fxml"));
                AnchorPane reportview = (AnchorPane) loader.load();
                dialogstage.setTitle("New Report");
                dialogstage.initModality(Modality.WINDOW_MODAL);
                dialogstage.initOwner(mainStage);
    ...
    public void showHistoryReport(User user) {
        try {
            ...
            loader.setLocation(MainApp.class.getResource("../view/HistoryReportView.fxml"));
            AnchorPane historytview = (AnchorPane) loader.load();
    ...
    public void showReportOverview(User user) {
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(MainApp.class.getResource("../view/ReportOverview.fxml"));
