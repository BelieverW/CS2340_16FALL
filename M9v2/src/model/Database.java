...
public class Database {
     ...
     */
    public void registerUser(String name, String password, String email, UserLevel level) {
        User newuser;
     ...
     * @throws IOException
     */
    public User editProfile(User user, String username, String password, String email, UserLevel level) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        User a1 = new User("hehe", "123456");
        Database db = new Database();
        List<User> users = db.getUsers();
        System.out.println(users.contains(a1));
    }
     */
