...
public class Worker extends User {
     ...
     * @param pw     the user's password
     */
    public Worker(String name, String pw) {
        super(name, pw);
    }
     ...
     * @return to show if submission is suceed
     * @throws IOException handle exception
     */
    public static boolean submitWorkerReport(WorkerReport report) throws IOException {
        String user = report.getUser();
        String title = report.getTitle();
        String date = report.getDate();
        String location = report.getLocation();
        Condition waterCondition = ((WorkerReport)report).getWaterCondition();
        String virusPPM = ((WorkerReport)report).getVirusPPM();
        String contaminantPPM = ((WorkerReport)report).getContaminantPPM();
