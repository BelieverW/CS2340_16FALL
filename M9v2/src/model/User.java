...
public class User {
    ...
    protected final ObjectProperty<UserLevel> level = new SimpleObjectProperty<>();
    //private StringProperty homeAddress = new SimpleStringProperty();
    protected StringProperty  emailAddress = new SimpleStringProperty();
    ...
    public boolean equals(Object o) {
        return getUserName().equals(((User) o).getUserName()) && getPassword().equals(((User) o).getPassword());
    }
     ...
     */
    public boolean submitReport(Report report) throws IOException {
     ...
     * @return Map<String, String> a map contains information about that report
     */
    public Map<String, String> viewReport(Report report) {
